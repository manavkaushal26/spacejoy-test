    ...
    <>
      ...
      <Layout>
        <Head>
          {PricingPageMeta}
          <title key="title">
            Online Interior Design Packages Starting at ${pricingData[0]?.salePrice.value} on {company.product} | Start
            a Project
          </title>
          <meta
            key="description"
          ...
          <meta
            key="og-image"
            property="og:image"
            content={`${imageKit.baseDeliveryUrl}/image/upload/c_scale,q_auto,w_600/v1593540199/web/seo/pricing_page_x3ni4v.jpg`}
          />
          ...
          <meta
            ...
            content={`${company.product}'s online interior design packages are suited to fit every need and budget. Pick a package and work with one of expert designers to design your room online`}
          />
          {/* /c_scale,q_auto,w_600 */}
          <meta
            key="twitter-image"
            name="twitter:image"
            content={`${imageKit.baseDeliveryUrl}/v1593540199/web/seo/pricing_page_x3ni4v.jpg`}
          />
        </Head>
        <Layout.Banner />
        <Layout.Header />
