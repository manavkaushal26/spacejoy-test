        ...
        >
          {(data?.designImages || []).map((item) => {
            return (
              <li key={item} className="relative">
                <div className="group overflow-hidden bg-gray-100 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 cursor-pointer">
                  <img
                    alt=""
                    src={item}
          ...
          <li className="flex items-center justify-center">
            <Link href="/interior-designs">
              <p className="text-md underline text-spj-red flex cursor-pointer space-x-1 items-center">
                <span>See more designs</span> <LinkIcon className="h-4 w-4" />
              </p>
            </Link>
          </li>
        </ul>
      ...
      <div className="mt-4">
        <div className="mt-1 grid grid-cols-1 gap-4 sm:grid-cols-3">
          {designTeamData
            ...
            .map((person) => (
              <a href={`/designers/${person.firstName.toLowerCase()}-${person.lastName.toLowerCase()}`} target="_blank">
                <div
                  key={person.id}
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-sm font-medium text-gray-900 font-semibold tracking-tight text-gray-500">
        ...
        <Layout.Body>
          <div className="container max-w-screen-xl px-4 mx-auto xl:p-0">
            <div>
              <div>
                {data?.coverImageUrl ? (
                  <img alt="" src={data?.coverImageUrl} className="h-32 w-full object-cover lg:h-48" />
                ) : null}
              </div>
              <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                  <div className="ring-4 ring-white rounded-md relative h-40 w-40">
                    {data?.icon ? (
                      <Image
                  ...
                  <div className="sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                    <div className="min-w-0 flex-1 block lg:flex justify-between  items-center">
                ...
                <div className="mt-6 hidden min-w-0 flex-1 sm:block 2xl:hidden">
                  <h1 className="truncate text-2xl font-bold text-gray-900">{data?.firstName}</h1>
                </div>
              </div>
              ...
              <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">{currentTab}</div>
            </div>
