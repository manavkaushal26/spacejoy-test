      ...
      <Layout>
        ...
        <Layout.Body>
          ...
          {/* <div className="container px-4 mx-auto mt-16 mb-6 xl:px-20 sm:mt-40 sm:mb-12">
            <Link href="https://store.spacejoy.com/collections/fall-sale-25-off-collection" passHref>
              <a target="_blank">
                <div className="relative w-full aspect-[364/45] shadow-md hover:shadow-lg">
                  <Image
                    src="https://res.cloudinary.com/spacejoy/image/upload/fl_lossy,q_100/w_1920,e_sharpen/v1726992557/spj-v2/strip_4_jlg2he.png"
                    alt="sale banner"
                    layout="fill"
                    objectFit="cover"
