            ...
            <Link href="https://store.spacejoy.com/" passHref>
              <a target="_blank">
                <div className="relative w-full aspect-[364/45] shadow-md hover:shadow-lg">
                  <Image
                    src="https://res.cloudinary.com/spacejoy/image/upload/fl_lossy,q_100/w_1920,e_sharpen/v1724992814/spj-v2/Extra_10_off_on_all_orders_above_1000_1_pbcm9l.jpg"
                    alt="sale banner"
                    layout="fill"
                    objectFit="cover"
