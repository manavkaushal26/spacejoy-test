...
const JoyversePrivacyPolicy = (props: Props) => {
  return (
    <Layout>
      <Head>
        <title key="title">Joyverse Privacy Policy</title>
      ...
      <Layout.Body>
        <div className="container px-4 mx-auto my-16 antialiased text-black break-words mb-28 joyverse-privacy-policy">
          <SectionTitle title="Joyverse Privacy Policy" feature={`Last updated: Tuesday, December 5, 2023`} />
          <p>
            This privacy notice for Joyverse Innovation Labs Inc. (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot;
            or &quot;our&quot;), describes how and why we might collect, store, use, and/or share (&quot;process&quot;)
          ...
          <p>
            ...
            personal information depending on how you interact with ProYuga® Advanced Technologies Ltd. and the
          ...
          <p>
            ...
            data and Game Play data(refer below for more details).
          </p>
          <p>
          ...
          <ul>
            <li>
              <p>
                <em>Technical Data and App Data.</em> When you play or use our Game and its Services, we collect
                necessary data like headset and controller position so that the game &amp; its services are functional,
          ...
          <ul>
            ...
            <li>
              ...
              players including your username (encrypted form unless in the game), play history, and scores.
            </li>
            <li>
              Service Providers. Your personal data are also processed by Service Providers, which ensures the creation
              and management of statistics, error reports concerning the game and its services as well as to offer
              in-game services.
            </li>
            <li>
          ...
          <address>Joyverse Innovation Labs Inc.</address>
          <address>900 Pepper Tree Ln, 9208</address>
          <address>Santa Clara, CA 95051</address>
