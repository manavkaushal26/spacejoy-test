  ...
  return (
    <div className="flex my-auto space-x-3">
      ...
      <a
        ...
        className="p-2 text-gray-800 bg-gray-100 rounded hover:text-blue-800 focus:ring-1 focus:ring-gray-500 focus:outline-none"
      >
      ...
      {/* <a
        ...
        className="p-2 text-gray-800 bg-gray-100 rounded hover:text-blue-400 focus:ring-1 focus:ring-gray-500 focus:outline-none"
      >
