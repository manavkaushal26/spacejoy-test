    ...
    <div className="">
      <div className="flex space-x-10">
        ...
        <div className="flex flex-col py-8 px-5 shadow-sm rounded-xl bg-[#f0f0f0]">
          <div className=" text-lg leading-normal">Know more</div>
          <div className="mt-8 flex flex-col space-y-3">
            <Link href={`${oldSpacejoyUrl}/online-room-design`} passHref>
              <a target="_blank" className=" text-sm font-normal hover:underline">
                How it works{'  '}→
              </a>
            </Link>
