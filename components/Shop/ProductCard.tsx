    ...
    <div>
      <Link
        href={
          useRetailLink
            ? product.retailLink
            : `/product-view${productVertical ? `/${productVertical}` : '/product'}/${
          ...
          <div className="flex flex-col bg-white justify-between rounded-lg h-full hover:z-30 hover:scale-[1.02] relative transition hover:shadow-xl">
            <div className={` p-4 ${showViewDetails ? 'p-4' : ''} `}>
              ...
              <small className="mt-4 text-xs text-gray-500 capitalize">
                {product?.whiteLabelName ||
                  product?.retailer?.whiteLabelName ||
                  (product?.retailer as GenericObj)?.name ||
                  product?.retailer}
              </small>
