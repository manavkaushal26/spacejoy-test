...
const bannerImages = [
  // {
  //   src: 'https://res.cloudinary.com/spacejoy/image/upload/fl_lossy,q_100/w_1920,e_sharpen/v1727513708/spj-v2/Colorful_Bold_Flash_Sale_Instagram_Post_3_fd3vha.png',
  //   mobileSrc: '',
  //   link: '',
  // },
  {
