    ...
    <div className="container relative mx-auto">
      <div className="absolute inset-0">
        <Image
          ...
          src={isScreenSmall ? "https://res.cloudinary.com/spacejoy/image/upload/v1644042492/web/homepage-v3/Website-design-set-92_wymkdg.jpg" : "https://res.cloudinary.com/spacejoy/image/upload/v1648726729/web/homepage-v3/jonathan-borba-COzqEKjaxqo-unsplash_1_u6m2q2.jpg"}
          alt="home banner"
          layout="fill"
          placeholder="blur"
          ...
          <div className="flex flex-col space-y-2">
            <Link href={`${oldSpacejoyUrl}/new-project`} passHref>
              <a
                target="_blank"
                type="button"
                className="group text-center overflow-hidden shadow-sm hover:shadow-lg text-base sm:text-lg text-white py-3 xl:py-3 px-4 xl:px-10 mt-4 rounded-xl bg-gray-900 tracking-wide focus:ml-0.5 focus:ring-1 focus:ring-offset-1 focus:ring-offset-white focus:ring-gray-400 focus:outline-none"
              >
                Start Your Project
              </a>
            </Link>
            <Link href={`${oldSpacejoyUrl}/interior-designs`} passHref>
              <a
                target="_blank"
                type="button"
                className="group text-center overflow-hidden shadow-sm hover:shadow-lg text-base sm:text-lg text-black py-3 xl:py-3 px-4 xl:px-10 mt-4 rounded-xl bg-gray-100 tracking-wide focus:ml-0.5 focus:ring-1 focus:ring-offset-1 focus:ring-offset-white focus:ring-gray-400 focus:outline-none"
              >
