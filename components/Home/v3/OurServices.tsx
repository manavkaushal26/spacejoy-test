...
const OurServices = ({ type = 'carousel' }: Props) => {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-spj-red-light/50 mt-16 sm:mt-24">
      {/* <svg
        id="wave"
      ...
      <MaxWidthContainer className="z-10 pt-12 sm:pt-20">
        <SectionHeading
          ...
          title="Interior design made accessible"
