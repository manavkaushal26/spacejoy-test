  ...
  return (
    <div className="container max-w-7xl pl-4 mx-auto sm:px-4">
      ...
      <div className="lg:hidden collections-slider">
        <Carousel imageCount={fakeCollectionData?.length || 0} responsive={sliderSettings} arrows={false}>
          {fakeCollectionData.map((collection) => (
            <div key={collection.id} className="shadow-md rounded-xl">
              ...
              <div className="bg-white p-5 rounded-bl-xl rounded-br-xl">
                ...
                <Link href={collection.href} passHref>
                  <a className="text-gray-700 text-sm font-semibold py-1.5 rounded-lg hover:bg-gray-50 px-5 border border-gray-600 flex items-center justify-center mt-3 w-fit">
                    Shop Now
                  </a>
                </Link>
              </div>
      ...
      <div className="hidden lg:grid grid-cols-4 gap-6">
        {fakeCollectionData.map((collection) => (
          <div key={collection.id} className="shadow-md rounded-xl transition duration-200 hover:shadow-lg">
            <div className="relative aspect-[46/25]">
              <Image
                src={collection.imgSrc}
                alt={collection.title}
            ...
            <div className="bg-white p-5 rounded-bl-xl rounded-br-xl">
              ...
              <Link href={collection.href} passHref>
                <a
                  target="_blank"
                  className="text-gray-700 text-sm font-semibold py-1.5 rounded-lg hover:bg-gray-50 px-5 border border-gray-600 flex items-center justify-center mt-3 w-fit"
                >
                  Shop Now
                </a>
              </Link>
