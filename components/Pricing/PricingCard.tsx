...
const PricingCard: React.FC<PricingCardInterface> = ({ pricingItem }) => {
  ...
  return (
    <div className=' overflow-hidden relative'>
      ...
      >
        <div className="p-6">
          <h2 className="text-lg leading-6 font-bold text-gray-900 capitalize">{pricingItem?.name}</h2>
        ...
        {pricingItem?.excludedFeatures.length > 0 && (
          <div className="pt-6 pb-8 px-6">
            <h3 className="text-xs font-medium text-gray-900 tracking-wide uppercase">What&apos;s excluded</h3>
            <ul className="mt-6 space-y-4">
