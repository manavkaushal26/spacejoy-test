    ...
    <div className="container px-4 mx-auto antialiased mb-28">
      ...
      <div className="mt-6">
        ...
        <p className="text-base text-gray-500">
          ...
          <br/>
          <h1> Partial refunds will only be considered for those projects that have been delivered within 4 months of the project start date. After 4 months, no design refunds will be issued.</h1>
        </p>
      </div>
      <div className="mt-6">
