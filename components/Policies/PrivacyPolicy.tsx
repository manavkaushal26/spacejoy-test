...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="w-full privacy-policy container mx-auto px-4 mb-28 antialiased break-words">
      <SectionTitle title="Spacejoy Privacy Policy" feature={`Effective Date: Jan 01st, 2020`} />

      <div className="mt-6 space-y-2">
        <h2 className="text-lg sm:text-2xl">1. Introduction</h2>
        <div className="space-y-3">
          <p>Welcome to Neo Design Labs Inc.</p>
          <p>
            Our Privacy Policy governs your visit to{' '}
            <a href="https://www.spacejoy.com/" target="_blank" rel="noopener noreferrer">
              https://www.spacejoy.com/
            </a>
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">2. Definitions</h2>
        <div className="space-y-3  ">
          <p>
            ...
            website operated by Neo Design Labs Inc.
          </p>
          <p>
            <span className="font-bold">PERSONAL DATA</span> means data about a living individual who can be identified
          ...
          <p>
            <span className="font-bold">COOKIES</span> are small files stored on your device (computer or mobile
            device).
          </p>
          <p>
            <span className="font-bold">COOKIES</span> are small files stored on your device (computer or mobile
          ...
          <p>
            <span className="font-bold">DATA CONTROLLER</span> means a natural or legal person who (either alone or
            jointly or in common with other persons) determines the purposes for which and the manner in which any
            personal data are, or are to be, processed. For the purpose of this Privacy Policy, we are a Data Controller
            of your data.
          </p>
          <p>
            <span className="font-bold">DATA PROCESSORS (OR SERVICE PROVIDERS)</span> means any natural or legal person
          ...
          <p>
            <span className="font-bold">DATA SUBJECT</span> is any living individual who is the subject of Personal
            Data.
          </p>
          <p>
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">3. Information Collection and Use</h2>
        <div className="space-y-3  ">
          <p>
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">4. Types of Data Collected</h2>
        <div className="space-y-3">
          <div className="space-y-3">
            <h3>Personal Data</h3>
            <p>
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              Service by or through a mobile device (“<span className="font-bold">Usage Data</span>”).
            </p>
            <p>
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              <span className="font-bold">Location Data</span>”). We use this data to provide features of our Service,
          ...
          <div className="space-y-3">
            ...
            <ol style={{ listStyle: 'lower-alpha' }}>
              ...
              <li>
                <span className="font-semibold">Preference Cookies: </span>We use Preference Cookies to remember your
              ...
              <li>
                <span className="font-semibold">Advertising Cookies: </span>Advertising Cookies are used to serve you
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">5. Use of Data</h2>
        <div className="space-y-3">
          <p>Neo Design Labs Inc. uses the collected data for various purposes:</p>
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">6. Retention of Data</h2>
        <div className="space-y-3  ">
          <p>
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">7. Transfer of Data</h2>
        <div className="space-y-3  ">
          <p>
          ...
          <p>
            Neo Design Labs Inc. will take all the steps reasonably necessary to ensure that your data is treated
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">8. Disclosure of Data</h2>
        <div className="space-y-3  ">
          <p>We may disclose personal information that we collect, or you provide:</p>
          <ol className="list-decimal">
            <li>
              <span className="font-semibold">Disclosure for Law Enforcement.</span>
              <p>
            ...
            <li>
              <span className="font-semibold">Business Transaction.</span>
              <p>
            ...
            <li>
              <span className="font-semibold">Other cases. We may disclose your information also:</span>
              <ol type="a" style={{ listStyle: 'lower-roman' }}>
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">9. Security of Data</h2>
        <div className="space-y-3  ">
          <p>
      ...
      <div className="mt-8 space-y-2">
        ...
        <div className="space-y-3  ">
          ...
          <p>
            ...
            systems, please email us at <a href="mailto:hello@spacejoy.com">hello@spacejoy.com</a>.
          </p>
          ...
          <ol style={{ listStyleType: 'lower-alpha' }}>
            ...
            <li>
              the right to withdraw consent. You also have the right to withdraw your consent at any time where we rely
      ...
      <div className="mt-8 space-y-2">
        ...
        <div className="space-y-3  ">
          ...
          <ol style={{ listStyleType: 'lower-alpha' }}>
            ...
            <li>users are able to change their personal information by emailing us at hello@spacejoy.com.</li>
          </ol>
      ...
      <div className="mt-8 space-y-2">
        ...
        <div className="space-y-3  ">
          ...
          <ol style={{ listStyleType: 'lower-alpha' }}>
            <li>
              <span className="font-semibold">What personal information we have about you. </span>If you make this
            ...
            <li>
              <span className="font-semibold">To delete your personal information.</span> If you make this request, we
              will delete the personal information we hold about you as of the date of your request from our records and
              direct any service providers to do the same. In some cases, deletion may be accomplished through
              de-identification of the information. If you choose to delete your personal information, you may not be
              able to use certain functions that require your personal information to operate.
            </li>
            <li>
              <span className="font-semibold">To stop selling your personal information.</span> We don&apos;t sell or
              rent your personal information to any third parties for any purpose. You are the only owner of your
            ...
            <p>
              To exercise your California data protection rights described above, please send your request(s) by one of
              the following means:
            </p>
            <p>
              By email: <a href="mailto:hello@spacejoy.com">hello@spacejoy.com</a>
            </p>
            <p>
              By phone number: <a href="tel:+1 (310) 483-7722">+1 (310) 483-7722</a>
            </p>
          </ol>
          <p>
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">13. Security of Data</h2>
        <div className="space-y-3">
          <p>
            We may employ third party companies and individuals to facilitate our Service (“
            <span className="font-semibold">Service Providers</span>”), provide Service on our behalf, perform
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">14. Analytics</h2>
        <div className="space-y-3">
          ...
          <p>
            For more information on what type of information Firebase collects, please visit the Google Privacy Terms
            web page:{' '}
            <a href="https://policies.google.com/privacy?hl=en" target="_blank" rel="noopener noreferrer">
              https://policies.google.com/privacy?hl=en
            </a>
          ...
          <p>
            <span className="font-semibold">Segment.io</span>
            <br />
            Segment.io is a web traffic analysis tool. You can read the Privacy Policy for Segment.io here:
            <a href="https://segment.com/legal/privacy/" target="_blank" rel="noopener noreferrer">
          ...
          <p>
            ...
            <a href="https://mixpanel.com/optout/" target="_blank" rel="noopener noreferrer">
          ...
          <p>
            ...
            Mixpanel:{' '}
            <a href="https://mixpanel.com/terms/" target="_blank" rel="noopener noreferrer">
              https://mixpanel.com/terms/
            </a>
          </p>
          <p>
            <span className="font-semibold">Unity Analytics</span>
            <br />
            Unity Analytics is provided by Unity Technologies.
          </p>
          <p>
            For more information on what type of information Unity Analytics collects, please visit their Privacy Policy
            page:{' '}
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">15. CI/CD tools</h2>
        <div className="space-y-3">
          ...
          <p>
            <span className="font-semibold">Bitrise</span>
            <br />
            Bitrise is provided by Bitrise Limited.
          </p>
          <p>
            Bitrise is a Continuous Integration and Delivery (CI/CD) Platform as a Service with a main focus on mobile
            app development (iOS, Android, React Native, Flutter, and so on).{' '}
          </p>
          <p>
            For more information on what data Bitrise collects for what purpose and how the protection of the data is
            ensured, please visit Bitrise Privacy Notice page:{' '}
            <a
              href=" https://www.bitrise.io/privacy"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-500"
            >
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">16. Behavioral Remarketing</h2>
        <div className="space-y-3">
          <p>
            Neo Design Labs Inc. uses remarketing services to advertise on third party websites to you after you visited
            our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past
            visits to our Service.
          </p>
          <p>
            <span className="font-semibold">Google Ads (AdWords)</span>
            <br />
          ...
          <p>
            <span className="font-semibold">Bing Ads Remarketing</span>
            <br />
          ...
          <p>
            ...
            <a href="https://www.facebook.com/help/164968693837950" target="_blank" rel="noopener noreferrer">
          ...
          <p>
            ...
            <a href="http://youradchoices.ca/" target="_blank" rel="noopener noreferrer">
          ...
          <p>
            You can opt-out from Pinterest&apos;s interest-based ads by enabling the “Do Not Track” functionality of
          ...
          <p>
            ...
            page:{' '}
            <a href="https://about.pinterest.com/en/privacy-policy" target="_blank" rel="noopener noreferrer">
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">17. Payments</h2>
        <div className="space-y-3">
          <p>
          ...
          <p>
            <span className="font-semibold">PayPal or Braintree:</span>
            <br />
          ...
          <p>
            <span className="font-semibold">Apple Store In-App Payments:</span>
            <br />
            Their Privacy Policy can be viewed at:{' '}
            <a
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">18. Links to Other Sites</h2>
        <div className="space-y-3">
          <p>
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">19. Children&apos;s Privacy</h2>
        <div className="space-y-3">
          <p>
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">20. Changes to This Privacy Policy</h2>
        <div className="space-y-3">
          <p>
      ...
      <div className="mt-8 space-y-2">
        <h2 className="text-lg sm:text-2xl">21. Contact Us</h2>
        <div className="space-y-3">
          <p>If you have any questions about this Privacy Policy, please contact us:</p>
          <p>
            By email:{' '}
            <a href="mailto:hello@spacejoy.com" target="_blank" rel="noopener noreferrer">
              hello@spacejoy.com
            </a>
            .
          </p>
          <p>
            By phone number:{' '}
            <a href="tel:+1 (310) 483-7722" target="_blank" rel="noopener noreferrer">
              +1 (310) 483-7722
            </a>
            .
          </p>
